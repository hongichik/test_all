...
from ncs_data import load_pickle, count_nodes_from_pickle
...
def main():
    ...
    ds_key = f'retailrocket/COTREC' if opt.dataset == 'retailrocket' else opt.dataset
    legacy = f'nhom3/SelfContrastiveLearningRecSys/COTREC/datasets/{opt.dataset}'
    train_data = load_pickle('SelfContrastiveLearningRecSys', ds_key, 'train.txt', f'{legacy}/train.txt')
    test_data = load_pickle('SelfContrastiveLearningRecSys', ds_key, 'test.txt', f'{legacy}/test.txt')
    all_train = load_pickle('SelfContrastiveLearningRecSys', ds_key, 'all_train_seq.txt', f'{legacy}/all_train_seq.txt')
