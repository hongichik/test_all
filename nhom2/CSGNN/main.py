...
parser.add_argument('--dataset', default='nowplaying', help='dataset name: diginetica/nowplaying/retailrocket/...')
...
def main():
    ...
    legacy = f'nhom2/CSGNN/datasets/{opt.dataset}/id'
    train_data = load_pickle('CSGNN', opt.dataset, 'id/train.txt', f'{legacy}/train.txt')
    test_data = load_pickle('CSGNN', opt.dataset, 'id/test.txt', f'{legacy}/test.txt')
    train_cate = load_pickle('CSGNN', opt.dataset, 'id/category_train.txt', f'{legacy}/category_train.txt')
    test_cate = load_pickle('CSGNN', opt.dataset, 'id/category_test.txt', f'{legacy}/category_test.txt')
