...
def main():
    ...
    train_data = load_pickle('COTREC', opt.dataset, 'train.txt', f'{legacy}/train.txt')
    test_data = load_pickle('COTREC', opt.dataset, 'test.txt', f'{legacy}/test.txt')
    all_train = load_pickle('COTREC', opt.dataset, 'all_train_seq.txt', f'{legacy}/all_train_seq.txt')
