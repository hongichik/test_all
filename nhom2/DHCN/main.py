...
parser.add_argument('--dataset', default='sample', help='dataset name: diginetica/Nowplaying/sample/retailrocket')
...
def main():
    legacy = f'nhom2/datasets/{opt.dataset}'
    train_data = load_pickle('DHCN', opt.dataset, 'train.txt', f'{legacy}/train.txt')
    test_data = load_pickle('DHCN', opt.dataset, 'test.txt', f'{legacy}/test.txt')
